...
echo ">>>> Create Kubernetes namespaces..."
...
echo ">>>> Add bootstrap and configs for Vault server..."
...
echo ">>>> Install, configure, and start PostgreSQL in Kubernetes..."
${DIR?}/../../deployments/postgres/run.sh

echo ">>>> Install, configure, and start Vault server..."
helm install vault \
  --namespace="${NAMESPACE?}" \
